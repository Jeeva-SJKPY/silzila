...
public class WhereClause {
    ...
    public static String buildWhereClause(List<FilterPanel> filterPanels, String vendorName)
        ...
        for (int i = 0; i < filterPanels.size(); i++) {
            ...
            String singlePanelWhereString = filterPanelWhereString(filterPanel.getFilters(), filterPanel.getShouldAllConditionsMatch(), vendorName);
    ...
    public static String filterPanelWhereString (List<Filter> filters,Boolean allConditionMatch, String vendorName) throws BadRequestException{
        ...
        for (int j = 0; j < filters.size(); j++) {
            ...
            String field = filter.getIsCalculatedField() 
                            ? calculatedFieldQueryComposer.composeQuery(filter.getCalculatedField(), vendorName) 
                            : (filter.getIsField()
